...
THREE_SHOT_PYTHON_CODE = """
Let's solve mathematical word problems in a careful, formal manner. The solution will follow the following format: 
1- The solution is a list of equations and variables.
2- The last equation is the goal: which variable will contain the answer to the problem.
3- Use all the numbers in the question.

Question = "Solve 367 = 299*y + 965 + 5681 for y"
Python Solution: "[[eq 367 = 299*y + 965 + 5681]] [[var y]]"

Question = "Solve -52*a - 95 = 82*a + 39 for a"
Python Solution: "[[eq -52*a - 95 = 82*a + 39]] [[var a]]"

Question = "Solve -10*t = -5*t + 5*t for t."
Python Solution: "[[eq -10*t = -5*t + 5*t]] [[var t]]"
